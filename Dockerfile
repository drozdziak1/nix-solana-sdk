...
FROM rust-with-deps as solana-rust-downloaded
RUN git clone https://github.com/solana-labs/rust solana-rust
WORKDIR solana-rust

FROM solana-rust-downloaded as solana-rustc-built
RUN ./build.sh
